...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <span class="fas fa-users text-info mt-2 "> Data Transaksi</span>         
    </div>
			
    <div class="card-body">
		<div style="float: left;">		
			<!-- Button tambah transaksi -->
			<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#input-transaksi">
				<i class="fas fa-plus-circle"></i> Tambah transaksi Baru
			</button>
			<a href="pages/cetak-data-transaksi-peminjaman.php" class="btn btn-success"><i class="fa fa-print"></i> Cetak Data transaksi</a>
		</div>	
